        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div>
            <p
              ...
              style={{ color: "#9378fe" }}
            >
              Programa Premium 1:1 Â· 4 Meses Â· Por AplicaciÃ³n
            </p>
            ...
            <p className="mt-6 text-lg md:text-xl text-white/70 leading-relaxed max-w-xl">
              ...
              conocimiento con un negocio propio que reemplace su sueldo y les dÃ©
              libertad.
            </p>
            <div className="mt-10">
              <TidyCalButton className="inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-medium text-white transition-opacity hover:opacity-90 bg-[#9378fe]">
                Solicitar llamada de valoraciÃ³n â†’
              </TidyCalButton>
            </div>
          </div>

          {/* Right â€” mockup image */}
          <div className="aspect-[4/3] rounded-[1.25rem] overflow-hidden">
            <img
              src={expoMockup}
              alt="Exponencial â€” Notion, Claude, LinkedIn y Substack."
