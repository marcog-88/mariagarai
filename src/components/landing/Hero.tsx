...
export const Hero = () => {
  return (
    <section
      id="top"
      className="relative overflow-hidden hero-gradient pt-16 pb-8 md:pt-36 md:pb-20 lg:pb-0"
    >
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 bottom-0 h-32 md:hidden z-10"
