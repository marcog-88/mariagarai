      ...
      <div className="container-tight px-8 sm:px-8 relative">
        <div className="flex flex-col lg:flex-row gap-10 md:gap-12 lg:items-stretch">
          ...
          <div className="animate-fade-up order-2 lg:order-1 flex flex-col justify-center w-full lg:w-[60%] py-8 lg:py-0 lg:pb-24">
            ...
            <p className="mt-6 max-w-xl font-serif text-[clamp(1.125rem,1.8vw,1.5rem)] font-light text-foreground/85 leading-snug">
              <span className="block font-medium text-foreground mb-4 text-[1.375rem] md:text-3xl leading-tight">Vales más que para un trabajo de 9 a 5.</span>
              Construye una carrera independiente con múltiples vías de ingreso.
            </p>
            <p className="mt-4 max-w-xl font-serif italic text-[clamp(1.35rem,2.2vw,1.75rem)] font-light text-[#9378fe] leading-snug">
