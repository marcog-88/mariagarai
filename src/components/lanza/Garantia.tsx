          ...
          <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-8 md:gap-12 items-start">
            ...
            <div>
              ...
              <p className="mt-8 text-sm md:text-sm lg:text-base text-primary-foreground/80 leading-relaxed">
                Me comprometo a que al final de las 8 semanas tengas tu oferta validada, tu
                método de ventas montado y al menos 10 conversaciones reales de venta
                completadas. Si llegamos al final del programa y eso no está, seguimos
                trabajando hasta que lo esté. Sin coste adicional.
              </p>
              <p className="text-sm md:text-sm lg:text-base text-mint mt-4 leading-snug">
                Solo acepto un número limitado de plazas en cada cohorte para poder dar el
                nivel de atención que esto requiere.
              </p>
            </div>
          </div>
        </div>
