  ...
  return (
    ...
    >
      <div className="container-tight">
        ...
        <p className="mt-12 text-lg md:text-xl text-primary-foreground/80 leading-relaxed max-w-3xl">
        ...
        <p className="mt-8 font-serif italic text-2xl md:text-4xl text-mint text-center md:text-left">
